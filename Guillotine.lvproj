...
<Project Type="Project" LVVersion="17008000">
	...
	<Item Name="Target" Type="RT myRIO">
		...
		<Property Name="alias.value" Type="Str">roboRIO-3792-FRC.local</Property>
...
AddOutputFilter chunkFilter
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="AutoDrive.vi" Type="VI" URL="../Step Autonomous/AutoDrive.vi"/>
			<Item Name="AutoEject.vi" Type="VI" URL="../Step Autonomous/AutoEject.vi"/>
			<Item Name="AutoFastDrive.vi" Type="VI" URL="../Step Autonomous/AutoFastDrive.vi"/>
			<Item Name="AutoIntake.vi" Type="VI" URL="../Step Autonomous/AutoIntake.vi"/>
			<Item Name="AutoLift.vi" Type="VI" URL="../Step Autonomous/AutoLift.vi"/>
			<Item Name="Autonomous.vi" Type="VI" URL="../Step Autonomous/Autonomous.vi"/>
			<Item Name="AutoTurn.vi" Type="VI" URL="../Step Autonomous/AutoTurn.vi"/>
			<Item Name="AutoVisionDrive.vi" Type="VI" URL="../Step Autonomous/AutoVisionDrive.vi"/>
			<Item Name="cube vision.vi" Type="VI" URL="../vision 2018 vi/cube vision.vi"/>
			<Item Name="dataclusterlocal.ctl" Type="VI" URL="../TypeDefs/dataclusterlocal.ctl"/>
			<Item Name="Fly.vi" Type="VI" URL="../Calc/Fly.vi"/>
			<Item Name="FRC_NetworkCommunication.dll" Type="Document" URL="FRC_NetworkCommunication.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="gamedata.vi" Type="VI" URL="../Variables/gamedata.vi"/>
			<Item Name="gyroglobal.vi" Type="VI" URL="../Calc/gyroglobal.vi"/>
			<Item Name="image to RGB array.vi" Type="VI" URL="../vision 2018 vi/image to RGB array.vi"/>
			<Item Name="joyaxes.ctl" Type="VI" URL="../TypeDefs/joyaxes.ctl"/>
			<Item Name="joybuttons.ctl" Type="VI" URL="../TypeDefs/joybuttons.ctl"/>
			<Item Name="libc.so.6" Type="Document" URL="libc.so.6">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="Localdata.ctl" Type="VI" URL="../TypeDefs/Localdata.ctl"/>
			...
			<Item Name="PotLift.vi" Type="VI" URL="../Calc/PotLift.vi"/>
			<Item Name="RGB to HSV and range.vi" Type="VI" URL="../vision 2018 vi/RGB to HSV and range.vi"/>
			<Item Name="Setpoint Angle Global Variable.vi" Type="VI" URL="../Calc/Drive Strait Teleop/Setpoint Angle Global Variable.vi"/>
			<Item Name="Sol.vi" Type="VI" URL="../Calc/Sol.vi"/>
			<Item Name="Teleop_DriveFwd.vi" Type="VI" URL="../Calc/DriveFWDWorking/Teleop_DriveFwd.vi"/>
			<Item Name="Teleop_Twist3ModeJohnny.vi" Type="VI" URL="../Calc/Drive Strait Teleop/Teleop_Twist3ModeJohnny.vi"/>
			<Item Name="TeleopDriveFrwdsub.vi" Type="VI" URL="../Calc/DriveFWDWorking/TeleopDriveFrwdsub.vi"/>
			<Item Name="threshhold rowcol sums.vi" Type="VI" URL="../vision 2018 vi/threshhold rowcol sums.vi"/>
			<Item Name="trim image.vi" Type="VI" URL="../vision 2018 vi/trim image.vi"/>
			<Item Name="TurnSlow.vi" Type="VI" URL="../Calc/TurnSlow.vi"/>
			<Item Name="TypeDefAuto.ctl" Type="VI" URL="../Step Autonomous/TypeDefAuto.ctl"/>
			<Item Name="TypeDefEnumSelection.ctl" Type="VI" URL="../Step Autonomous/TypeDefEnumSelection.ctl"/>
			<Item Name="visionglobal.vi" Type="VI" URL="../vision 2018 vi/visionglobal.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
